 ...
 * Generated for Laravel 5.0.33 on 2015-06-20.
 *
...
namespace {
    ...
    class HttpResponse extends \Illuminate\Http\Response{
    ...
    class JsonHelper extends \App\Facades\JsonHelper{
        ...
        public static function getSuccessResponse($data = null){
            return \App\Helpers\JsonHelper::getSuccessResponse($data);
        }
         ...
         * @static 
         */
        public static function getErrorResponse($code, $msg){
            return \App\Helpers\JsonHelper::getErrorResponse($code, $msg);
        }
